...
const defaultSources = [
  `${repoPath}/src/app/index.ts`,
  `${repoPath}/src/auth/index.ts`,
  `${repoPath}/src/database/index.ts`,
  `${repoPath}/src/firestore/index.ts`,
  `${repoPath}/src/instance-id/index.ts`,
  `${repoPath}/src/machine-learning/index.ts`,
  `${repoPath}/src/messaging/index.ts`,
  `${repoPath}/src/project-management/index.ts`,
  `${repoPath}/src/remote-config/index.ts`,
  `${repoPath}/src/security-rules/index.ts`,
  `${repoPath}/src/storage/index.ts`,
  `${repoPath}/src/main-entrypoint.ts`,
];
...
function stripPath(path) {
  const prefix = '/docs/reference/admin/node/';
