...
import {FirebaseApp, FirebaseAccessToken, initializeApp, getApps, getApp} from '../../src/firebase-app';
...
describe('FirebaseApp', () => {
  ...
  describe('#delete()', () => {
    ...
    it('should call delete() on each service\'s internals', () => {
      const app = initializeApp(mocks.appOptions, mocks.appName);
      app.getService(mocks.serviceName, () => {
        return mockServiceFactory(app);
      });
      app.getService(mocks.serviceName + '2', () => {
        return mockServiceFactory(app);
      });
